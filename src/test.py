...
import numpy as np
from src.model import subcortical_seg_model, vanila_3dunet
from src.model.subcortical_seg_model import SingleConv, DoubleConv, ExtResNetBlock
import time
...
if __name__ == '__main__':
    ...
    test_image_dir = '/home/hao/Hao/AGS/Dataset/predict_hd/test_registration_image_HM/all_image'
    test_image_dir = '/home/hao/Hao/AGS/Dataset/3D_T1_pre_processing/registration2_rename_image_HM'
    #test_image_dir = '/home/hao/Hao/AGS/src/skull_stripping_for_oguz/resampled_image_HM'

    test_label_dir = '/home/hao/Hao/AGS/Dataset/predict_hd/test_registration/all_roi'
    test_roi_dir = test_label_dir

    prefix = 'HD_skull_stripping_no_attention_midconv_k5_check'
