...
from intensity_normalization_github.intensity_normalization.errors import NormalizationError
from intensity_normalization_github.intensity_normalization.utilities import io, hist
...
def ws_normalize(img_dir, contrast, mask_dir=None, output_dir=None, write_to_disk=True):
    ...
    if output_dir is None:
        ...
        for fn in data:
            ...
            output_files.append(os.path.join(output_dir, 'ws_' +base + ext))
